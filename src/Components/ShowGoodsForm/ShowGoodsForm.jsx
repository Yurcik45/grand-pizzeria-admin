...
import photoCezar from '../../IMG/photo_cezar.jpg'
import photoSoup from '../../IMG/photo_soup.jpg'
...
const ShowGoodsForm = () => {
    ...
    const ShowGoodsTableArray = [
        {
            ShowGoodsFormClassName: 'ShowGoodsForm',
            NavigationTopicClassName: 'NavigationTopic',
            showGoodsTableClassName: 'showGoodsTable',
            showGoodsTableHeaderClassName: 'showGoodsTableHeader',
            headerDivClassName: 'headerDiv',
            headerItemDivClassName: 'headerItemDiv',
            showGoodsTableBodyClassName: 'showGoodsTableBody',
            bodyDivClassName: 'bodyDiv',
            defaultInputClassName: 'defaultInput',
            buttonCheckClassName: 'buttonCheck',
            changesELClassName: 'changesEL',
        }
        ]
        ...
        <div className={'ShowGoodsForm'}>
            ...
            <div className="showGoodsTable">
                <div className="showGoodsTableHeader">
                    <div className={'headerDiv'}>Image</div>
                    <div className={'headerDiv'}>Name</div>
                    <div className={'headerDiv'}>Category</div>
                    <div className={'headerDiv'}>Price</div>
                    <div className={'headerDiv'}>Description</div>
                    <div className={'headerItemDiv'}>Ed</div>
                    <div className={'headerItemDiv'}>Del</div>
                </div>
                {
                        <div className="showGoodsTableBody">
                            <div className={'bodyDiv'}>
                                <img src={photoCezar} alt="image will be here"/>
                                    <Input
                            ...
                            <div className={'bodyDiv'}>
                                'Томатний соус, моцарела, куряче філе, панчета, листя салату, рукола, соус цезар, пармезан'
                                    <Input
                                        className={'defaultInput'}
                                        type="text"
