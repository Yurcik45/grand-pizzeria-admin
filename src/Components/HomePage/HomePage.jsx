...
const HomePage = () => {
    ...
    const [setImage, setImageHandler] = useState({status: false, item : 'd'})
    ...
    return (
        <div
            className={
                    (setImage.item === 'a') ? 'HomePage a' : ((setImage.item === 'b') ? 'HomePage b' : 'HomePage'
                        // : (setImage.item === 'b' ? 'HomePage c'  : 'HomePage')
                    )
        }>
           <MainLandHeader/>
            <p><a name="top"></a></p>
            ...
            <div className="mainNavigationLinks">
                <div className="mainLinks">
                    <NavLink
                        onChange={() => setImageHandler({status: true, item : 'a'})}
                        to="/MenuItems" >їжа</NavLink>
                    <NavLink
                        onFocus={() => setImageHandler({status: true, item : 'b'})}
                        to="/MenuItems">напої</NavLink>
                    <NavLink
                        onFocus={() => setImageHandler({status: true, item : 'c'})}
                        to="/FoundUs">тепло</NavLink>
                </div>
                <div className="links">
            ...
            <div className="pause">
                ...
                <NavLink to="/FeedBack">
                    <Button className={'pauseButton'} value={'Перейти до відгуків'}/>
                </NavLink>
            </div>
            <div className="remarkkids">
                <div className="remarkkidsText">
                    ...
                    <p>GRANDE PIZZERIA є першим kids-friendly преміум закладом Івано-Франківська. Саме тому, якщо
                        ...
                        приходьте до нас!</p>
                    <NavLink to="/FoundUs">
                        <Button className={'eventButton'} value={'Віртуальний тур'}/>
                    </NavLink>
